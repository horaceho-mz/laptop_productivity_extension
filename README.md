...
- 🚀 **My progress** — each stage of building, from first idea to a working device.
- ✅❌ **What works and what doesn't** — the building methods I try, and whether they hold up or fail.
- 🔄 **My versions** — how the design changes and gets better over time (v1, v2, and so on).
